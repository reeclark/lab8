...
public class Students {
	public static void main(String[] args) {
		...
		String[] name = { "Tim Smith", "Bob Clark", "Tom Cook" };
		String[] food = { "Burgers", "Cake", "Pizza" };
		String[] home = { "Detorit, MI", "Lansing, MI", "Flint, MI" };
		...
		LabValidator.myRegex(scan, "What would you like to know about " + name[input - 1].substring(0, 3)
				+ " (enter \"hometown\" or \"favorite food\"): ", "hometown");
